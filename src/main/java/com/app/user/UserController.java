...
public class UserController {
	...
	public ResponseEntity<UserData> getByToken(@RequestHeader("Authorization") String authHeader) {
	...
	public ResponseEntity<UserData> updateProfile(@RequestBody UserData user,
